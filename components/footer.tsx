...
{ href: "https://instagram.com/harryashu_", icon: Instagram, label: "Instagram" },
{ href: "https://twitter.com/harryashu_", icon: Twitter, label: "Twitter" },
]
...
className="text-sm text-muted-foreground mt-4 block hover:text-primary transition-colors"
>
