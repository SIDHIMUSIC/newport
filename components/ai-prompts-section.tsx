  ...
  chatgpt: [
    {
      ...
      text: "Act as a senior software engineer and review my code. Focus on performance, security, and best practices. Provide specific suggestions with code examples.",
